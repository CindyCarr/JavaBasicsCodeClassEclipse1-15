package com.synyax.reviewclass1;
...
public class Review {
	...
	public static void main(String[] args) {
			...
			int famousBox=21455555; // most of the time you guys will use this box 
			//to store whole number
			long notThatFamousBox=4545454545454l;
			//int bigInteger=new; 
			// bigInteger("11225222252222222222222222222222222222222222222222222222222222222222222");
